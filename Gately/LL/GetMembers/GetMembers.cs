...
namespace Gately.LL.GetMembers
{
    class GetMembers
    {
        ...
        public bool get() {
            ...
            //"California_Institute_of_Technology", "Stanford_University",

            var arr = new string[] {  "University_of_California_Berkeley", "University_of_California_Davis", "University_of_California_Irvine", 
